...
class ContactForm extends Model
{
    ...
    {
        return [
            'name' => Module::t('site', 'FEEDBACK_FORM_ATTR_NAME'),
            'email' => Module::t('site', 'FEEDBACK_FORM_ATTR_EMAIL'),
            'subject' => Module::t('site', 'FEEDBACK_FORM_ATTR_SUBJECT'),
            'body' => Module::t('site', 'FEEDBACK_FORM_ATTR_BODY'),
            'verifyCode' => Module::t('site', 'FEEDBACK_FORM_ATTR_VERIFY_CODE'),
        ];
    }
