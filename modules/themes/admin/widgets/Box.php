...
namespace modules\themes\admin\widgets;
...
/**
 * Class Box
 * @package modules\themes\admin\widgets
 * Theme Box widget.
 */
    ...
    protected function initButtons()
    {
        if (!isset($this->buttons['create'])) {
            $this->buttons['create'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Module::t('themes-admin', 'Box-Create')
                ]
            ];
        }
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Module::t('themes-admin', 'Box-Delete'),
                    'data-method' => 'delete'
                ]
            ];
        }
        ...
        if (!isset($this->buttons['batch-delete'])) {
            $this->buttons['batch-delete'] = [
                ...
                'options' => [
                    'id' => 'batch-delete',
                    'class' => 'btn-default',
                    'title' => Module::t('themes-admin', 'Box-Delete-Selected'),
                ]
            ];
        }
        ...
        if (!isset($this->buttons['cancel'])) {
            $this->buttons['cancel'] = [
                ...
                'options' => [
                    'class' => 'btn-default',
                    'title' => Module::t('themes-admin', 'Box-Cancel'),
                ]
            ];
        }
    }
        ...
        if (strpos($this->buttonsTemplate, '{batch-delete}') !== false && $this->grid !== null && isset($this->buttons['batch-delete'])) {
            ...
            $view->registerJs(
                "jQuery(document).on('click', '#batch-delete', function (evt) {" .
                    ...
                    "if (keys == '') {" .
                        "alert('" . Module::t('themes-admin', 'You need to select at least one item.') . "');" .
                    "} else {" .
                        "if (confirm('" . Module::t('themes-admin', 'Are you sure you want to delete selected items?') . "')) {" .
                            "jQuery.ajax({" .
                                "type: 'POST'," .
